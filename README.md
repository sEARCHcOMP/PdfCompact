...
> **Version 3.11.1** · 2026-07-02
> ブラウザ完結型・サーバー不要・100% LOCAL の PDF ツールキット

[![download](https://img.shields.io/badge/download-ZIP%20(3.11.1)-1a85ff?style=for-the-badge)](https://pdfcompact.pages.dev/PDF_Compact.zip)
...
| 📲 **スマホ転送** | QRコードを読むだけでスマホの写真・ファイルをPCへ受信(オンライン専用) |
